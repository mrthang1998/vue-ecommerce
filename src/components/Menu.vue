      ...
      <div class="container">
        <div class="row">
          <div class="col-xl-2 text-center p-2">
            <a to="/"
              ><img
                src="../assets/images/logo/Logoweb2.png"
                alt=""
                class="logo"
            /></a>
          </div>
          ...
          <div class="col-xl-2 p-4">
            <router-link class="text-decoration-none text-dark" to="/cart"
              ><i class="fa fa-shopping-cart cart-logo mr-3" aria-hidden="true"
                >&nbsp;Cart: {{ GET_CART.length }}</i
              ></router-link
            >
            <i
              class="fa fa-search search-logo"
              aria-hidden="true"
