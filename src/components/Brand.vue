      ...
      <section class="panel">
        ...
        <div class="panel-body">
          <ul class="nav prod-cat">
            <li>
              <a href="#" class="active"
                ><i class="fa fa-angle-right"></i> Dress</a
              >
              <ul class="nav">
            ...
            <li>
              <a href="#"
                ><i class="fa fa-angle-right"></i> Bags &amp; Purses</a
              >
            </li>
            <li>
            ...
            <li>
              <a href="#"
                ><i class="fa fa-angle-right"></i> Coat &amp; Jacket</a
              >
            </li>
            <li>
          ...
          <section class="panel">
            <div class="pro-img-box">
              <img
                ...
                alt=""
              />
              <a @click="addToCart(item)" class="adtocart">
...
@import "http://netdna.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js";
body {
  margin-top: 20px;
  background: #f1f2f7;
}
